...
`mmit.cv(target.mat, feature.mat, param_grid, n_folds = 3, scorer = NULL, pruning = TRUE, future.seed = FALSE)`
...
library(mmit)
  ...
  if(require(future)){ plan(multiprocess)}
  set.seed(1)
  trees <- mmif(target.mat, feature.mat, max_depth = Inf, margin = 2.0, loss = "hinge", min_sample = 1, future.seed = TRUE)
```
...
`mmif.cv(target.mat, feature.mat, param_grid, n_folds = 3, scorer = NULL, future.seed = FALSE)`
